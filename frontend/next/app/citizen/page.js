  ...
  return (
    <div style={{ background: 'var(--bg-card)', border: '1px solid var(--border)', borderRadius: '12px', padding: '0', overflow: 'hidden', transition: 'all 0.2s' }}>
      ...
      <div style={{ padding: '20px' }}>
        ...
        {report.ai_label && (
          <div style={{ display: 'inline-flex', alignItems: 'center', gap: '4px', fontSize: '0.7rem', color: '#10d9a0', background: 'rgba(16,217,160,0.1)', padding: '2px 8px', borderRadius: '4px', marginBottom: '8px', border: '1px solid rgba(16,217,160,0.2)' }}>
